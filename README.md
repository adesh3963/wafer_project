...
#### Prediction
     same steps has been taken for prediction data for data validation as training 
     the data will be passed through cluster model and prefered model will be slected for prediction
